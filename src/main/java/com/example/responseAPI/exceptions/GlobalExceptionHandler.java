package com.example.responseAPI.exceptions;
...
public class GlobalExceptionHandler {
    ...
    public ApiResponse<List<String>> buildApiResponse(
            int code,
            Status status,
            String message,
            List<String> data,
    ...
    public ResponseEntity<ApiResponse<List<String>>> handleNoResourceFound(
